<template>
  <NuxtLink :to="`/resumes/${id}/experiences/${experience.id}`">
    <div
      class="border border-gray-100 rounded-lg shadow-md px-4 py-1 flex items-center space-x-4 hover:bg-gray-100"
    >
      <input
        type="checkbox"
        :checked="checked"
